...
-- TODO: Move this to the recording area
...
local recordingEvents = {
  ...
  ---@param _ ignored - The first parameter (ignored).
  ---@param slot number - The loot slot that has been cleared.
      function (_, slot)
        addon:SendMessage("recording/lootSlotCleared", slot)
      end
}
...
function events:startRecording_Events()
  ...
  for k, v in pairs(recordingEvents) do
